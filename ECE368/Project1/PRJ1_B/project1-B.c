...
float calutil(Server * servers)
{
	...
	for(i = 0; i< 64; i++)
	{
		if(servers[i].endtime >max)
		{
			max = servers[i].endtime;
		}
	} 
	for(i = 0; i< 64; i++)
	{
